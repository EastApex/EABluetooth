#
#  Be sure to run `pod spec lint EABluetooth.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "EastApex" => "apexfit@eastapex.com" }
  # Or just: spec.author    = "Aye"
  # spec.authors            = { "Aye" => "" }
  # spec.social_media_url   = "https://twitter.com/Aye"
