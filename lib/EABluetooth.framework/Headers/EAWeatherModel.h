...
/** 最低温度 */
@property(nonatomic, assign) NSUInteger minTemperature;

/** 最高温度 */
@property(nonatomic, assign) NSUInteger maxTemperature;
...
/** 当前温度 */
@property(nonatomic, assign) NSUInteger currentTemperature;
